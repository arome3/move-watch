  ...
  return (
    <div className="p-4 bg-slate-900 border-t border-slate-700 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <p className="text-xs text-slate-500 uppercase">Full Hash</p>
        ...
        <div>
          <p className="text-xs text-slate-500 uppercase">Sequence Number</p>
          <p className="text-sm text-white">{detail.sequenceNumber}</p>
        </div>
        {detail.vmStatus && (
          <div className="md:col-span-2">
            <p className="text-xs text-slate-500 uppercase">VM Status</p>
