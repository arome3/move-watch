  ...
  return (
    <div className="mt-4 space-y-4">
      ...
      <div className="space-y-2">
        <label htmlFor="sender" className="block text-sm font-medium text-slate-300">
        ...
        <input
          ...
          className={`w-full bg-slate-900 border rounded-lg px-3 py-2 text-sm font-mono text-slate-100
                     ...
                     ${errors.sender ? 'border-red-500' : 'border-slate-700'}`}
        />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          <label htmlFor="maxGas" className="block text-sm font-medium text-slate-300">
            Max Gas Amount
          </label>
          <input
            id="maxGas"
            ...
            className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm
                      font-mono text-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-500
                      focus:border-transparent transition-colors"
          />
        </div>

        <div className="space-y-2">
          <label htmlFor="gasPrice" className="block text-sm font-medium text-slate-300">
            Gas Unit Price
          </label>
          <input
            id="gasPrice"
