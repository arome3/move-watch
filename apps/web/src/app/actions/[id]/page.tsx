    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="mb-6 text-sm">
        <ol className="flex items-center gap-2 text-dark-400">
          ...
          <li>/</li>
          <li className="text-dark-200">{action.name}</li>
        </ol>
      </nav>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-2xl font-bold text-dark-100">{action.name}</h1>
              <span
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div className="bg-dark-800 rounded-lg p-4 border border-dark-700">
          <div className="text-2xl font-bold text-dark-100">{action.executionCount}</div>
          <div className="text-sm text-dark-400">Executions</div>
        </div>
        <div className="bg-dark-800 rounded-lg p-4 border border-dark-700">
          <div className="text-2xl font-bold text-green-400">{action.successCount}</div>
          <div className="text-sm text-dark-400">Successful</div>
        </div>
        <div className="bg-dark-800 rounded-lg p-4 border border-dark-700">
          <div className="text-2xl font-bold text-red-400">{action.failureCount}</div>
